...
class ViewController: UIViewController {
   ...
   let sarki8 = SarkiModel(sarkiId: 8, sarkiAdi: "Seni Her Gördüğümde", sarkiSanatci: "Erkin Koray", sarkiAlbumKapagi: "erkinKoray")
    ...
    func collectionViewTasarim(){
        ...
        let hucreGenisligi = sarkilarCollectionView.bounds.width - 35
        let hucreUzunlugu = (sarkilarCollectionView.bounds.height - 30)/4
...
extension ViewController : UICollectionViewDelegate , UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
      ...
      if collectionView == self.sarkiDerlemesiCollectionView{
